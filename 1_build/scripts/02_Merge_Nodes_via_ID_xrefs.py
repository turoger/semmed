...
def parse_args(args=None):
    parser = argparse.ArgumentParser(
        ...
        usage='02_Merge_nodes_via_ID_xrefs.py [<args>] [-h | --help]'
    )
...
def main(args): 
    ...
    rels = pd.read_csv(f'../data/drugcentral_rel_{args.dc_date}.csv')
    print('Loading drugcentral_ids dataframe')
    dc_ids = pd.read_csv(f'../data/drugcentral_ids_{args.dc_date}.csv')
    print('Loading drugcentral_syn dataframe')
    syn = pd.read_csv(f'../data/drugcentral_syn_{args.dc_date}.csv')
    ...
    nodes = gt.remove_colons(pd.read_csv(f'../data/nodes_{args.semmed_version}.csv'))
    ...
    edges = gt.remove_colons(pd.read_csv(f'../data/edges_{args.semmed_version}.csv', converters={'pmids':eval}))
    ...
    new_nodes.to_csv(f'../data/nodes_{args.semmed_version}_nodes_consolidated.csv', index=False)
    edges.to_csv(f'../data/edges_{args.semmed_version}_nodes_consolidated.csv', index=False)

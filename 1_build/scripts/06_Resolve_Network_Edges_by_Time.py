...
def main(args):
    ...
    tqdm.pandas()
    nodes = gt.remove_colons(pd.read_csv(f'../data/nodes_{args.semmed_version}_cons_6_metanode.csv'))
    edges = gt.remove_colons(pd.read_csv(f'../data/edges_{args.semmed_version}_cons_6_metanode.csv'))

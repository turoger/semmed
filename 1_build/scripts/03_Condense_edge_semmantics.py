...
def main(args): 
    ...
    nodes = gt.remove_colons(pd.read_csv(f'../data/nodes_{args.semmed_version}_nodes_consolidated.csv'))
    edges = gt.remove_colons(pd.read_csv(f'../data/edges_{args.semmed_version}_nodes_consolidated.csv', converters={'pmids':eval}))
    ...
    nodes.to_csv(f'../data/nodes_{args.semmed_version}_consolidated_condensed.csv', index=False)
    edges.to_csv(f'../data/edges_{args.semmed_version}_consolidated_condensed.csv', index=False)

...
Help()
{
	...
	""
	"Options:"
	"   --apikey, -a            UMLS apikey; required."
	"   --host, -H              postgreSQL host name; required."
    "   --pass, -P              postgreSQL password; required."
	"   --port, -p              postgreSQL port number; required."
	"   --user, -u              postgreSQL user login; required."

...
def main(args):
    ...
    print('Loading data')
    nodes = pd.read_csv(f'../data/nodes_{args.semmed_version}_consolidated_condensed.csv')
    edges = pd.read_csv(f'../data/edges_{args.semmed_version}_consolidated_condensed.csv')
    ...
    result.to_csv(f'../data/edges_{args.semmed_version}_consolidated_condensed_filtered_001.csv', index=False)
    nodes.to_csv(f'../data/nodes_{args.semmed_version}_consolidated_condensed_filtered_001.csv', index=False)
